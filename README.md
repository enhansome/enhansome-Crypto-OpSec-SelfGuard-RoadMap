...
* [Croc Tool](https://github.com/schollz/croc) ⭐ 40,282 | 🐛 3 | 🌐 Go | 📅 2026-09-09
...
* [Store SSH keys in the Secure Enclave!](https://github.com/maxgoedjen/secretive) ⭐ 8,855 | 🐛 168 | 🌐 Swift | 📅 2026-09-09
* [Blockchain dark forest selfguard handbook](https://github.com/SunWeb3Sec/DeFiHackLabs/tree/main/academy/user_awareness/01_handbook/en) ⭐ 6,772 | 🐛 9 | 🌐 Solidity | 📅 2026-09-09
...
> Aegis Authenticator is open source (licensed under GPL v3) and the source code [can be found here](http://github.com/beemdevelopment/Aegis) ⭐ 13,048 | 🐛 118 | 🌐 Java | 📅 2026-09-06. The issue with Authy is that it depends on a phone number which can be changed through an email request, allowing anyone access to HOTP/TOTP after an approximate 4-day wait period. To avoid that, disable multi-device function in Authy's settings!
...
* [Authenticator app for storing your 2FA secrets](https://github.com/ente-io/auth/#readme) ⭐ 28,754 | 🐛 230 | 🌐 Dart | 📅 2026-09-09
...
* [A curated list of privacy & security-focused software and services](https://github.com/Lissy93/awesome-privacy) ⭐ 9,856 | 🐛 2 | 🌐 Astro | 📅 2026-09-08
...
* [Guide to securing and improving privacy on macOS](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,513 | 🐛 6 | 🌐 Shell | 📅 2026-09-07
...
* [MacOS Security](https://github.com/usnistgov/macos_security) ⭐ 2,461 | 🐛 21 | 🌐 YAML | 📅 2026-09-05
...
* [algoVPN](https://github.com/trailofbits/algo) ⭐ 30,369 | 🐛 77 | 🌐 Python | 📅 2026-09-09
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,631 | 🐛 153 | 🌐 C | 📅 2026-01-19
* [rethink-app](https://github.com/celzero/rethink-app) ⭐ 5,390 | 🐛 630 | 🌐 Kotlin | 📅 2026-09-09
* [souin](https://github.com/darkweak/souin) ⭐ 999 | 🐛 73 | 🌐 Go | 📅 2026-09-02
...
* [DefaultCreds CheatSheet](https://github.com/ihebski/DefaultCreds-cheat-sheet/) ⭐ 6,738 | 🐛 0 | 🌐 Python | 📅 2026-07-09
...
* [Read More](https://github.com/OffcierCia/ultimate-defi-research-base) ⭐ 2,215 | 🐛 2 | 📅 2026-03-14
...
* [Awesome Security Hardening Guides](https://github.com/decalage2/awesome-security-hardening) ⭐ 6,548 | 🐛 125 | 📅 2026-05-05
* [Privacy.sexy Repo](https://github.com/undergroundwires/privacy.sexy) ⭐ 6,027 | 🐛 251 | 🌐 TypeScript | 📅 2026-02-13
* [A collection of practical security-focused guides and checklists for smart contract development](https://github.com/nascentxyz/simple-security-toolkit) ⭐ 1,235 | 🐛 1 | 📅 2023-11-15
* [AnonPlanet](https://anonymousplanet.org/links.html)
