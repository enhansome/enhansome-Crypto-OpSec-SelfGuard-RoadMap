...
* [Portuguese-Brazilian](https://github.com/OffcierCia/Crypto-OpSec-SelfGuard-RoadMap/blob/main/TranslationsOpSec/Portuguese.md) ⭐ 1,864 | 🐛 3 | 📅 2026-08-16
* [French](https://github.com/OffcierCia/Crypto-OpSec-SelfGuard-RoadMap/blob/main/TranslationsOpSec/French.md) ⭐ 1,864 | 🐛 3 | 📅 2026-08-16
...
* [Croc Tool](https://github.com/schollz/croc) ⭐ 40,242 | 🐛 1 | 🌐 Go | 📅 2026-09-05
...
* [Store SSH keys in the Secure Enclave!](https://github.com/maxgoedjen/secretive) ⭐ 8,847 | 🐛 170 | 🌐 Swift | 📅 2026-08-19
* [Blockchain dark forest selfguard handbook](https://github.com/SunWeb3Sec/DeFiHackLabs/tree/main/academy/user_awareness/01_handbook/en) ⭐ 6,767 | 🐛 4 | 🌐 Solidity | 📅 2026-09-05
...
> Aegis Authenticator is open source (licensed under GPL v3) and the source code [can be found here](http://github.com/beemdevelopment/Aegis) ⭐ 13,021 | 🐛 117 | 🌐 Java | 📅 2026-08-29. The issue with Authy is that it depends on a phone number which can be changed through an email request, allowing anyone access to HOTP/TOTP after an approximate 4-day wait period. To avoid that, disable multi-device function in Authy's settings!
...
* [Authenticator app for storing your 2FA secrets](https://github.com/ente-io/auth/#readme) ⭐ 28,674 | 🐛 239 | 🌐 Dart | 📅 2026-09-05
...
* [A curated list of privacy & security-focused software and services](https://github.com/Lissy93/awesome-privacy) ⭐ 9,845 | 🐛 3 | 🌐 Astro | 📅 2026-09-05
...
* [Guide to securing and improving privacy on macOS](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,508 | 🐛 6 | 📅 2026-08-29
...
* [MacOS Security](https://github.com/usnistgov/macos_security) ⭐ 2,460 | 🐛 18 | 🌐 YAML | 📅 2026-09-05
...
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,614 | 🐛 153 | 🌐 C | 📅 2026-01-19
* [rethink-app](https://github.com/celzero/rethink-app) ⭐ 5,378 | 🐛 650 | 🌐 Kotlin | 📅 2026-09-03
...
* [DefaultCreds CheatSheet](https://github.com/ihebski/DefaultCreds-cheat-sheet/) ⭐ 6,732 | 🐛 0 | 🌐 Python | 📅 2026-07-09
...
* [Malwoverview](https://github.com/alexandreborges/malwoverview) ⭐ 4,081 | 🐛 0 | 🌐 Python | 📅 2026-08-07
...
* [Awesome Security Hardening Guides](https://github.com/decalage2/awesome-security-hardening) ⭐ 6,546 | 🐛 125 | 📅 2026-05-05
* [Privacy.sexy Repo](https://github.com/undergroundwires/privacy.sexy) ⭐ 6,006 | 🐛 251 | 🌐 TypeScript | 📅 2026-02-13
* [A collection of practical security-focused guides and checklists for smart contract development](https://github.com/nascentxyz/simple-security-toolkit) ⭐ 1,233 | 🐛 1 | 📅 2023-11-15
* [AnonPlanet](https://anonymousplanet.org/links.html)
