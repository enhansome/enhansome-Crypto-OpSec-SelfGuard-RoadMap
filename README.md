...
* [Croc Tool](https://github.com/schollz/croc) ⭐ 40,203 | 🐛 1 | 🌐 Go | 📅 2026-09-01
...
* [Store SSH keys in the Secure Enclave!](https://github.com/maxgoedjen/secretive) ⭐ 8,843 | 🐛 170 | 🌐 Swift | 📅 2026-08-19
...
> Aegis Authenticator is open source (licensed under GPL v3) and the source code [can be found here](http://github.com/beemdevelopment/Aegis) ⭐ 13,011 | 🐛 117 | 🌐 Java | 📅 2026-08-29. The issue with Authy is that it depends on a phone number which can be changed through an email request, allowing anyone access to HOTP/TOTP after an approximate 4-day wait period. To avoid that, disable multi-device function in Authy's settings!
...
* [Authenticator app for storing your 2FA secrets](https://github.com/ente-io/auth/#readme) ⭐ 28,620 | 🐛 235 | 🌐 Dart | 📅 2026-09-02
...
* [A curated list of privacy & security-focused software and services](https://github.com/Lissy93/awesome-privacy) ⭐ 9,820 | 🐛 1 | 🌐 Astro | 📅 2026-08-30
...
* [openvpn-install](https://github.com/Nyr/openvpn-install) ⭐ 20,634 | 🐛 0 | 🌐 Shell | 📅 2026-07-02
* [An ultimate list of rules any on-chain survivor should follow to stay safe!](https://officercia.mirror.xyz/_nD1Rtxe1PplK-NQzIq9sl-KNtajQG0aKqYsV36RTjA)
...
* [Guide to securing and improving privacy on macOS](https://github.com/drduh/macOS-Security-and-Privacy-Guide) ⭐ 22,505 | 🐛 6 | 📅 2026-08-29
...
* [MacOS Security](https://github.com/usnistgov/macos_security) ⭐ 2,458 | 🐛 20 | 🌐 YAML | 📅 2026-09-02
...
* [algoVPN](https://github.com/trailofbits/algo) ⭐ 30,366 | 🐛 77 | 🌐 Python | 📅 2026-09-02
* [GoodbyeDPI](https://github.com/ValdikSS/GoodbyeDPI) ⭐ 28,608 | 🐛 153 | 🌐 C | 📅 2026-01-19
* [rethink-app](https://github.com/celzero/rethink-app) ⭐ 5,365 | 🐛 645 | 🌐 Kotlin | 📅 2026-08-24
...
* [DefaultCreds CheatSheet](https://github.com/ihebski/DefaultCreds-cheat-sheet/) ⭐ 6,728 | 🐛 0 | 🌐 Python | 📅 2026-07-09
...
* [Awesome InfoSec](https://github.com/onlurking/awesome-infosec) ⭐ 5,735 | 🐛 17 | 📅 2026-08-28
...
* [Malwoverview](https://github.com/alexandreborges/malwoverview) ⭐ 4,079 | 🐛 0 | 🌐 Python | 📅 2026-08-07
